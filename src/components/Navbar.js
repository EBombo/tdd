    ...
    <div className="">
      <nav className="h-[50px] lg:h-[120px] flex items-center justify-between flex-wrap px-4 bg-white shadow-navbar">
        ...
        <div className="block lg:hidden">
          <button className="flex items-center px-3 py-2 rounded text-black " onClick={() => setMenuDrawer((oldValue) => !oldValue)}>
        ...
        {menuDrawer && (
          <div className="absolute top-[50px] right-0 py-8 w-full block flex-grow lg:flex lg:items-center lg:w-auto bg-white">
            ...
            <div>
              ...
              <div className="text-center"><Button onClick={() => router.push("/login")}>Iniciar sesión</Button></div>
            </div>
          </div>
        )}
